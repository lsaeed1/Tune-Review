...
<head>
    ...
    <style>
        .preview-card { text-align: center; background: #f9f9f9; padding: 20px; border-radius: 12px; margin-top: 20px; border: 1px solid #ddd; }
        .preview-card img { max-width: 200px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); margin-bottom: 15px; }
        .preview-card h3 { margin: 0 0 5px 0; color: #1a1a2e; }
...
<div class="navbar">
    ...
    <div>
        ...
        <a href="addSong.php" class="btn-nav" style="background:#6a4faa;">Add a Song</a>
